...
namespace  WP_Social\Wpmet\Libs;

defined('ABSPATH') || exit;

if( !class_exists('\WP_Social\Wpmet\Libs\Plugins') ) {
                        ...
                        <div class="attr-col-lg-4">
                            <div class="wpmet-onboard-single-plugin">
                                <label>
                                    ...
                                    $plugin_status_title = isset( $plugin_data['title'] ) ? $plugin_data['title'] : esc_html__('Activate', 'wp-social');
                                    ?>
                                    <div class="wpmet-apps-footer">
                                        ...
                                        if( !empty($plugin_docs) ) :
                                            echo sprintf(
                                                ...
                                                esc_url($plugin_docs),
                                                esc_html__('Read Docs', 'wp-social')
                                            );
                                        endif;
                                        ?>
                                    </div>
